...
class TemperatureTest {
    ...
    @Test
    void test1() {
        double[] temperatures = { -111.71, -1230.10, 396.43, -29.51, -154.05,
                357.63, 41.42, 103.22, 275.01, 22.80, 48.23,
                80.56, 233.28, 11.32, 155.11, -85.16, 262.49, 64.64, 112.40, -62.19, -29.04, 53.75, 196.32, 104.93,
                -116.61, 351.53, 145.89, -51.23, -565.78, -119.66, -147.81,
                -183.68, 324.85, 218.08, -54.69, 26.61,
                ...
                12.77, 353.35, 178.02, -33.40, 65.69, 336.12, 114.90, 293.05,
                132.70, -155.02, -12381.98, -8585.58 };
    ...
    @Test
    public void test2() {
        double[] temperatures = { 116.97, 188.78, -1194.95, -4.62, 352.90,
                188.92, 330.08, 198.06, 305.96, -148.58,
        ...
        double expectedColdest = 3;
        double actualColdest = Temperature.coldest(temperatures);
        assertEquals(expectedColdest, actualColdest, TOLERANCE);
    }
    @Test
    public void test3() {
        double[] temperatures = { -54, 15, -41, 2, 6, 64, -13, 9, -32, -45,
                -454, 15, -41, -2500, 6, 64, -13, 9, -32, -45,
    ...
    public void test4() {
        double[] temperatures = { 178.34,77.07,102.77,142.30,72.18,142.87,68.12,74.89,97.13,16.83, 0.40,177.92,53.33,115.07,126.36,89.98,103.15,181.90,92.85,97.62,
                ...
                27.03,92.57,103.46,-1131.15,34.05};
    ...
    public void test5() {
        double[] temperatures = { -296.67, -119.69, -153.49, -207.38, -175.21, -372.48, -251.45, -300.14, -291.68,
                ...
                -398.21, -1121.70, -213.29, -306.85};

        double expectedColdest = 363;
        double actualColdest = Temperature.coldest(temperatures);
        assertEquals(expectedColdest, actualColdest, TOLERANCE);
    }
    @Test
    public void test6() {
        double[] temperatures = { -54, 15, -41, 2, 6, 64, -13, 9, -32, -545,
                -54, 15, -41, 2, 6, 64, -13, 9, -32, -45,
                -54, 15, -41, 2, 6, 64, -13, 9, -32, -45, -54, 15, -41, 2, 6, 64, -13, 9, -32, -45, -54, 15, -41, 2, 6,
